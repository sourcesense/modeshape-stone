...
public abstract class AbstractTestCase {
    ...
    public static Option[] configuration() {
        return options(felix(),
                       mavenConfiguration(),
                       wrappedBundle(mavenBundle("org.apache.sling","org.apache.sling.extensions.webconsolebranding","1.0.0")),
                       ...
                       systemProperty( "java.security.auth.login.config" ).value( "/tmp/jaas.conf" )
