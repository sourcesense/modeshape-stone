...
public abstract class AbstractTestCase {
    ...
    public static Option[] configuration() {
        return options(felix(),
                       ...
                       systemProperty( "sling.installer.dir" ).value( "${sling.home}/installer" ),
                       systemProperty( "sling.home" ).value( "/tmp/sling" ),
                       systemProperty( "ds.loglevel" ).value( "${org.apache.sling.commons.log.level}" ),
                       ...
                       systemProperty( "org.osgi.framework.storage" ).value( "${sling.home}/felix" ),
                       ...
                       systemProperty( "org.apache.sling.commons.log.file" ).value( "${sling.home}/logs/error.log" ),
                       ...
                       systemProperty( "felix.cm.dir" ).value( "${sling.home}/config" ),
